...
<body class="bg-gradient-to-br from-blue-600 to-red-500 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="bg-white/95 backdrop-blur-md w-full max-w-md rounded-2xl shadow-2xl p-8">
        <div class="text-center mb-8">
            ...
            <p class="text-sm text-gray-500 mt-2">Buat akun untuk mengakses sistem perpustakaan</p>
        </div>
        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" 
                       class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('name') border-red-500 @enderror" 
            ...
            <div class="mb-6">
                <label for="password_confirmation" class="block text-sm font-semibold text-gray-600 mb-1">Konfirmasi Kata Sandi</label>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600">
                Sudah punya akun? 
                <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-800 font-semibold transition">Login di sini</a>
            </p>
        </div>
    </div>
