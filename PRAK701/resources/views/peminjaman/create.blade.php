...
@section('title', 'Tambah Peminjaman - Perpustakaan')

@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-800">Tambah Transaksi Peminjaman</h1>
    <p class="text-gray-500 mt-2">Isi formulir di bawah untuk mencatat transaksi peminjaman baru</p>
</div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-3xl">
    <form action="{{ route('peminjaman.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-5">
            ...
            <div>
                <label for="tgl_kembali" class="block text-sm font-semibold text-gray-600 mb-2">Tanggal Kembali</label>
